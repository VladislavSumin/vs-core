 ...
 */
public interface LinkedTreeNode<T> : TreeNode<T, LinkedTreeNode<T>> {
    public val parent: LinkedTreeNode<T>?
}

public class LinkedTreeNodeImpl<T> internal constructor(
 ...
 */
public fun <T> LinkedTreeNode<T>.asSequenceUp(): Sequence<LinkedTreeNode<T>> = sequence {
